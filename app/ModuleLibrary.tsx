...
const modules: Module[] = [
  ...
  },
  {
    ...
    version: "v1.4 · labeled solid-foot dual mount",
    category: "Sensors & inputs",
    status: "Prototype",
    statusTone: "prototype",
    image: "/images/photocell.png",
    summary: "Three labeled dual-mount housings use the same 5 mm GL55-series photoresistor for ambient, interrupted-beam, or covered-light tests. Solid interstitial feet improve supportless underside printing.",
    ...
    parts: ["Ambient + / P base", "Beam + / P base", "Cover + / P base", "Solid support feet"],
    teacherNote: "All three retain Coupon-F, open tabs, and end-loaded M3 nuts. Six feet between stud centers support the cavity roof without changing the clutch. The photocell is non-polarized; + and P establish a consistent classroom wiring convention.",
    studentTip: "Choose the interaction, then connect + to 3V and P to the micro:bit signal/resistor junction.",
    download: "/downloads/photocell-module-family-v1-4-solid-feet.zip",
    dualMount: true,
  },
  {
    id: "potentiometer",
...
const developmentHistory: Record<string, HistoryItem[]> = {
  ...
  photocell: [
    ...
    { version: "v1.4", problem: "The hollow underside left long cavity-roof bridge spans that could print inconsistently without support.", change: "Added six solid interstitial feet between LEGO stud centers while preserving the Coupon-F rings, open cardboard tabs, and M3 nut paths.", result: "Current mesh-validated prototype; print one pilot before classroom quantities.", state: "Current" },
  ],
  potentiometer: [
