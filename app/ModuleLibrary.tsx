...
const modules: Module[] = [
  ...
  },
  {
    ...
    version: "v5.5 · 39 supports + 3.6 mm paths",
    category: "micro:bit",
    status: "Mechanism confirmed",
    statusTone: "mechanism",
    image: "/images/microbit-stand.png",
    summary: "An upright exact-guide stand with 39 solid roof supports, six anchored Coupon-F bores, 60 clear LEGO seating points, and two internal 3.6 × 1.8 mm cardboard paths.",
    ...
    parts: ["Exact-guide dual-mount stand", "39 solid roof supports", "6 open Coupon-F bores + C anchors", "Microbit Alligator Clip Guide v2", "3.2 / 3.4 / 3.6 mm brad coupon"],
    teacherNote: "Version 5.5 preserves the confirmed exact-guide cradle, bundled guide STL, and attribution while making all 39 safe non-clutch centers solid at 5.20 × 2.85 mm. Six Coupon-F bores remain open with C anchors, all 60 LEGO seating clearances remain open, and both top-open internal paths are 3.6 × 1.8 mm with clear head pockets and solid floors. Pilot one complete dual-mount assembly before a class set.",
    ...
    download: "/downloads/microbit-original-guide-stand-v5-5-solid-supports-internal-paths-anchor-feet-3p6.zip",
    dualMount: true,
  },
  {
    id: "servo-horizontal",
...
const developmentHistory: Record<string, HistoryItem[]> = {
  ...
  microbit: [
    ...
    { version: "v5.5", problem: "Thirty-nine hollow non-clutch centers left repeated unsupported roof bridges, and the paths needed the 3.6 mm classroom opening.", change: "Added 39 full 5.20 × 2.85 mm supports and widened both top-open paths to 3.6 × 1.8 mm while retaining six open Coupon-F bores with C anchors, all 60 LEGO clearances, and the exact guide and attribution.", result: "Current watertight, clearance-validated mechanism-confirmed recommendation; pilot the full stand, guide, LEGO, and cardboard assembly.", state: "Current" },
  ],
  "servo-horizontal": [
